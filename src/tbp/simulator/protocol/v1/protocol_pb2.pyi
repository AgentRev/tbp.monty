...
class AddObjectRequest(_message.Message):
    ...
    def __init__(
        self,
        name: _Optional[str] = ...,
        position: _Optional[_Union[VectorXYZ, _Mapping]] = ...,
        rotation: _Optional[_Union[QuaternionWXYZ, _Mapping]] = ...,
        scale: _Optional[_Union[VectorXYZ, _Mapping]] = ...,
        semantic_id: _Optional[int] = ...,
        primary_target_object: _Optional[int] = ...,
    ) -> None: ...
...
class AddObjectResponse(_message.Message):
    ...
    semantic_id: int
    def __init__(
        self, object_id: _Optional[int] = ..., semantic_id: _Optional[int] = ...
    ) -> None: ...

class LookDownAction(_message.Message):
    __slots__ = ("agent_id", "constraint_degrees", "rotation_degrees")
    ...
    def __init__(
        ...
        rotation_degrees: _Optional[float] = ...,
        constraint_degrees: _Optional[float] = ...,
    ) -> None: ...
...
class MoveForwardAction(_message.Message):
    ...
    distance: float
    def __init__(
        self, agent_id: _Optional[str] = ..., distance: _Optional[float] = ...
    ) -> None: ...

class MoveTangentiallyAction(_message.Message):
    __slots__ = ("agent_id", "direction", "distance")
    AGENT_ID_FIELD_NUMBER: _ClassVar[int]
    DISTANCE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        direction: _Optional[_Union[VectorXYZ, _Mapping]] = ...,
    ) -> None: ...

class OrientHorizontalAction(_message.Message):
    __slots__ = ("agent_id", "forward_distance", "left_distance", "rotation_degrees")
    AGENT_ID_FIELD_NUMBER: _ClassVar[int]
    ROTATION_DEGREES_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(
        ...
        agent_id: _Optional[str] = ...,
        rotation_degrees: _Optional[float] = ...,
        left_distance: _Optional[float] = ...,
        forward_distance: _Optional[float] = ...,
    ) -> None: ...

class OrientVerticalAction(_message.Message):
    __slots__ = ("agent_id", "down_distance", "forward_distance", "rotation_degrees")
    AGENT_ID_FIELD_NUMBER: _ClassVar[int]
    ROTATION_DEGREES_FIELD_NUMBER: _ClassVar[int]
...
class SetAgentPitchAction(_message.Message):
    ...
    pitch_degrees: float
    def __init__(
        self, agent_id: _Optional[str] = ..., pitch_degrees: _Optional[float] = ...
    ) -> None: ...
...
class SetAgentPoseAction(_message.Message):
    ...
    def __init__(
        self,
        agent_id: _Optional[str] = ...,
        location: _Optional[_Union[VectorXYZ, _Mapping]] = ...,
        rotation: _Optional[_Union[QuaternionWXYZ, _Mapping]] = ...,
    ) -> None: ...
...
class SetYawAction(_message.Message):
    ...
    rotation_degrees: float
    def __init__(
        self, agent_id: _Optional[str] = ..., rotation_degrees: _Optional[float] = ...
    ) -> None: ...
...
class StepRequest(_message.Message):
    ...
    def __init__(
        self,
        look_down: _Optional[_Union[LookDownAction, _Mapping]] = ...,
        look_up: _Optional[_Union[LookUpAction, _Mapping]] = ...,
        move_forward: _Optional[_Union[MoveForwardAction, _Mapping]] = ...,
        move_tangentially: _Optional[_Union[MoveTangentiallyAction, _Mapping]] = ...,
        orient_horizontal: _Optional[_Union[OrientHorizontalAction, _Mapping]] = ...,
        orient_vertical: _Optional[_Union[OrientVerticalAction, _Mapping]] = ...,
        set_agent_pitch: _Optional[_Union[SetAgentPitchAction, _Mapping]] = ...,
        set_agent_pose: _Optional[_Union[SetAgentPoseAction, _Mapping]] = ...,
        set_sensor_pitch: _Optional[_Union[SetSensorPitchAction, _Mapping]] = ...,
        set_sensor_pose: _Optional[_Union[SetSensorPoseAction, _Mapping]] = ...,
        set_sensor_rotation: _Optional[_Union[SetSensorRotationAction, _Mapping]] = ...,
        set_yaw: _Optional[_Union[SetYawAction, _Mapping]] = ...,
        turn_left: _Optional[_Union[TurnLeftAction, _Mapping]] = ...,
        turn_right: _Optional[_Union[TurnRightAction, _Mapping]] = ...,
    ) -> None: ...
    ...
    class AgentObservation(_message.Message):
        ...
        class SensorObservation(_message.Message):
            ...
            def __init__(
                ...
                raw: _Optional[bytes] = ...,
                rgba: _Optional[bytes] = ...,
                depth: _Optional[bytes] = ...,
                semantic: _Optional[bytes] = ...,
                semantic_3d: _Optional[bytes] = ...,
                sensor_frame_data: _Optional[bytes] = ...,
                world_camera: _Optional[bytes] = ...,
                pixel_loc: _Optional[bytes] = ...,
            ) -> None: ...

        AGENT_ID_FIELD_NUMBER: _ClassVar[int]
        SENSOR_OBSERVATIONS_FIELD_NUMBER: _ClassVar[int]
        agent_id: str
        sensor_observations: _containers.RepeatedCompositeFieldContainer[
            Observations.AgentObservation.SensorObservation
        ]
        def __init__(
            self,
            agent_id: _Optional[str] = ...,
            sensor_observations: _Optional[
                _Iterable[
                    _Union[Observations.AgentObservation.SensorObservation, _Mapping]
                ]
            ] = ...,
        ) -> None: ...

    AGENT_OBSERVATIONS_FIELD_NUMBER: _ClassVar[int]
    agent_observations: _containers.RepeatedCompositeFieldContainer[
        Observations.AgentObservation
    ]
    def __init__(
        self,
        agent_observations: _Optional[
            _Iterable[_Union[Observations.AgentObservation, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class ProprioceptiveState(_message.Message):
    ...
    class AgentState(_message.Message):
        ...
        class SensorState(_message.Message):
            __slots__ = ("position", "rotation", "sensor_id")
            SENSOR_ID_FIELD_NUMBER: _ClassVar[int]
            POSITION_FIELD_NUMBER: _ClassVar[int]
            ROTATION_FIELD_NUMBER: _ClassVar[int]
            sensor_id: str
        ...
        sensor_states: _containers.RepeatedCompositeFieldContainer[
            ProprioceptiveState.AgentState.SensorState
        ]
        def __init__(
            self,
            agent_id: _Optional[str] = ...,
            ...
            rotation: _Optional[_Union[QuaternionWXYZ, _Mapping]] = ...,
            motor_only_step: bool = ...,
            sensor_states: _Optional[
                _Iterable[_Union[ProprioceptiveState.AgentState.SensorState, _Mapping]]
            ] = ...,
        ) -> None: ...

    AGENT_STATES_FIELD_NUMBER: _ClassVar[int]
    agent_states: _containers.RepeatedCompositeFieldContainer[
        ProprioceptiveState.AgentState
    ]
    def __init__(
        self,
        agent_states: _Optional[
            _Iterable[_Union[ProprioceptiveState.AgentState, _Mapping]]
        ] = ...,
    ) -> None: ...
...
class StepResponse(_message.Message):
    ...
    def __init__(
        self,
        observations: _Optional[_Union[Observations, _Mapping]] = ...,
        proprioceptive_state: _Optional[_Union[ProprioceptiveState, _Mapping]] = ...,
    ) -> None: ...
